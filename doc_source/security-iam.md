# Identity and access management for AWS Lambda<a name="security-iam"></a>
...
How you use AWS Identity and Access Management \(IAM\) differs, depending on the work you do in Lambda\.
