      ...
      + [Programming Model](programming-model-v2.md)
         ...
         + [Programming Model for Authoring Lambda Functions in C#](dotnet-programming-model.md)
            ...
            + [Function Errors (C#)](dotnet-exceptions.md)
               + [Step 2.4: (Optional) Create a Lambda Function Authored in C#](get-started-step5-optional.md)
...
+ [Examples of How to Use AWS Lambda](use-cases.md)
   ...
   + [Using AWS Lambda with Scheduled Events](with-scheduled-events.md)
      + [Tutorial: Using AWS Lambda with Scheduled Events](with-scheduledevents-example.md)
         ...
         + [Step 6: Deploy With AWS SAM and AWS CloudFormation](with-sched-event-example-use-app-spec.md)
