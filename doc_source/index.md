...
+ [Managing AWS Lambda functions](lambda-functions.md)
   + [Configuring functions in the console](configuration-console.md)
   + [Configuring functions defined as container images](configuration-images.md)
   ...
   + [Lambda layers](configuration-layers.md)
   + [Configuring Lambda function memory](configuration-memory.md)
