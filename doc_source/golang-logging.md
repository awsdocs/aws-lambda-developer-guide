...
+ [Using the Lambda console](#golang-logging-console)
+ [Using the CloudWatch console](#golang-logging-cwconsole)
+ [Using the AWS Command Line Interface \(AWS CLI\)](#golang-logging-cli)
...
## Using the Lambda console<a name="golang-logging-console"></a>
...
## Using the CloudWatch console<a name="golang-logging-cwconsole"></a>
