...
**Topics**
+ [Viewing Logs in the AWS Management Console](#dotnet-logging-console)
+ [Using the AWS CLI](#dotnet-logging-cli)
+ [Deleting Logs](#dotnet-logging-delete)

## Viewing Logs in the AWS Management Console<a name="dotnet-logging-console"></a>
...
## Using the AWS CLI<a name="dotnet-logging-cli"></a>
...
## Deleting Logs<a name="dotnet-logging-delete"></a>
