...
**Topics**
+ [Viewing Logs in the AWS Management Console](#go-logging-console)
+ [Using the AWS CLI](#go-logging-cli)
+ [Deleting Logs](#go-logging-delete)

## Viewing Logs in the AWS Management Console<a name="go-logging-console"></a>
...
## Using the AWS CLI<a name="go-logging-cli"></a>
...
## Deleting Logs<a name="go-logging-delete"></a>
