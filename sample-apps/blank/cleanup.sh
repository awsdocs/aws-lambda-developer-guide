...
while true; do
    ...
    case $response in
        [Yy]* ) aws s3 rb --force s3://$OUTPUT_BUCKET; aws cloudformation delete-stack --stack-name lambda-blank; break;;
        [Nn]* ) aws cloudformation delete-stack --stack-name lambda-blank --retain-resources bucket; exit;;
